...
export default defineSemanticTokens.shadows({
  ...
  md: {
    value: {
      _light:
        '0 4px 6px -1px {colors.gray.50/5}, 0 2px 4px -2px {colors.gray.50/5}',
  ...
  lg: {
    value: {
      _light:
        '0 10px 15px -3px {colors.gray.50/5}, 0 4px 6px -4px {colors.gray.50/5}',
      _dark:
        '0 10px 15px -3px {colors.black/5}, 0 4px 6px -4px {colors.black/5}',
    },
  },
  xl: {
    value: {
      _light:
        '0 20px 25px -5px {colors.gray.50/5}, 0 10px 10px -6px {colors.gray.50/5}',
      _dark:
        '0 20px 25px -5px {colors.black/5}, 0 10px 10px -6px {colors.black/5}',
    },
  },
  '2xl': {
    value: {
